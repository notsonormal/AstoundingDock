...
namespace AstoundingApplications.AstoundingDock.Ui
{
    ...
    /// </remarks>
    class TwoListSynchronizer : IWeakEventListener
    {
        ...
        /// <param name="e">Event pData.</param>
        /// <returns>
        ...
        private void RemoveItems(IList list, NotifyCollectionChangedEventArgs e, Converter<object, object> converter)
        {
            ...
            // for the number of items being removed, remove the element from the Old Starting Index
