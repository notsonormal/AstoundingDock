...
namespace AstoundingApplications.AstoundingDock.Ui
{
    public class ListViewColumns : DependencyObject
    {
        ...
        /// <summary>
        /// Holds a reference to our parent ListView element
        /// </summary>
        ...
        /// </summary>
        /// <remarks>If this completeCallback seems unfamilar then please read
        ...
        /// <summary>
        /// Handles the SizeChanged event of the lv element.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="System.Windows.SizeChangedEventArgs"/> instance containing the event pData.</param>
        ...
        /// <summary>
        /// Handles the Loaded event of the lv element.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="System.Windows.RoutedEventArgs"/> instance containing the event pData.</param>
            ...
            if (gridView != null)
            {
                if (columns == null)
                {
                    ...
                    foreach (GridViewColumn column in gridView.Columns)
                    {
                        ...
                        // Resize any 'stretch rows' when any of the columns change size.
                        // http://stackoverflow.com/questions/2205151/wpf-gridviewcolumn-resize-event
                        ((INotifyPropertyChanged)column).PropertyChanged += (obj, args) =>
                        {
                            if (args.PropertyName == "ActualWidth" && columns.Contains(column))
                            {
