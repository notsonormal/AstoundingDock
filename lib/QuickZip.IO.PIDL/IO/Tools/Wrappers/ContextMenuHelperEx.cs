...
{
    internal class CustomMenuStructure
    {
    ...
    public static class ContextMenuHelperEx
    {
        ...
        public static void ConstructCustomMenu(IntPtr menu, string[] customItems, out List<IntPtr> menuPtrConstructed)
        {
            ConstructCustomMenu(menu, ParseCustomMenu(customItems), out menuPtrConstructed);
        }
        #endregion
