...
namespace System.IO
{
        ...
        IEquatable<FileSystemInfoEx>
    {
        ...
        public new FileAttributes Attributes { get; protected set; }
        public new DateTime LastWriteTime { get; protected set; }
        public new DateTime LastAccessTime { get; protected set; }
        public new DateTime CreationTime { get; protected set; }
